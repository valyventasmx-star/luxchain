...
import { ArrowLeft, ShieldCheck, Globe2, LockKeyhole, Sparkles } from "lucide-react";
...
export default function ProductClient({
  ...
  return (
    <main className="min-h-screen overflow-x-hidden" style={{ background: "var(--black)" }}>
      {showInquiry && (
        <InquiryModal
      ...
      <section className="mx-auto w-full max-w-[1500px] px-6 sm:px-8 lg:px-12 xl:px-16 pt-14 pb-28">
        <Link
          href="/catalog"
        ...
        <div className="mb-16 grid grid-cols-1 gap-8 lg:grid-cols-[1fr_420px] lg:items-end">
          ...
          <div className="lg:text-right">
            ...
            <p className="mt-2 text-xs uppercase tracking-widest" style={{ color: "var(--gray)" }}>
        ...
        <div className="grid grid-cols-1 gap-16 xl:grid-cols-[minmax(0,1fr)_430px] xl:gap-20">
          ...
          >
            ...
            <div className="mb-8">
              <p className="mb-2 text-xs uppercase tracking-widest" style={{ color: "var(--gray)" }}>
                Listed price
              </p>
            ...
            <p className="mt-5 text-center text-xs leading-relaxed" style={{ color: "var(--gray)" }}>
              Private concierge response within 2 hours. Full KYC, escrow, shipping, and legal transfer handled end-to-end.
            </p>
          </aside>
        </div>
